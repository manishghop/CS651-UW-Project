...
#check this line of code somehow i need to check if my code gets tweet stored into dstream
lines.foreachRDD(lambda rdd:rdd.saveAsTextFile(r"./results.txt%f" % time.time()))
